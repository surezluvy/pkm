...
<div class="admin-content-inner">
    ...
    <div class="uk-flex-inline uk-flex-middle">
        ...
        <h4 class="uk-margin-remove"> Daftar Pengurus </h4>
        <button class="uk-button uk-button-success uk-margin-medium-left admin-btn" href="#create-model" uk-tooltip="title: Create New User ; delay: 500 ; pos: top ;animation: uk-animation-scale-up" uk-toggle id="tombolTambah">
    ...
    <div class="uk-overflow-auto">
        <table class="uk-table uk-table-hover uk-table-middle uk-table-divider">
            ...
            <tbody>
                <?php 
                    $no = 1;
                    foreach ($data['pengurus'] as $user)
                { ?>
                <tr>
                    <td class="center firstLetter"> <?= $no++; ?> </td>
                    <td class="center firstLetter"> <?= $user['username'] ?> </td>
                    <td class="center firstLetter"> <?= $user['full_name'] ?> </td>
                    ...
                    <td class="uk-flex-inline uk-flex-middle aksi">
                        ...
                        <a href="<?= BASEURL; ?>/dashboard/hapusDataPengurus/<?= $user['id_user'] ?>">
